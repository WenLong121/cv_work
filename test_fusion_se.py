...
if __name__ == '__main__':
    ...
    p = "/root/ICAFusion/datasets/KAIST/labels/test"
    labels_list = os.listdir(p)
    labels_list.sort()
    if opt.data in ['./data/multispectral/kaist.yaml', './data/multispectral/FLIR-ADAS.yaml', './data/multispectral/VEDAI.yaml']:
        opt.verbose = True
